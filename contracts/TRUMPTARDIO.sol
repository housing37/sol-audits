 ...
 * https://t.me/trumptardioneth
 * https://x.com/trumptardioneth
 * https://trumptardio.net/
 */
...
contract TRUMPTARDIO is ERC20, Ownable {
    ...
    constructor() ERC20("TRUMPTARDIO", "TRUMPTARDIO") {
        IDexRouter _dexRouter = IDexRouter(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        setLimitExempt(address(_dexRouter), true);
        ...
        setLimitExempt(address(dexPair), true);
        ...
        marketingWallet = address(0x8bd775F6b7F730F567AE5ADf80Ca628A3B1C3756);

        // exclude from paying fees or having max transaction amount
        setFeeExempt(msg.sender, true);
        setFeeExempt(address(this), true);
        setFeeExempt(address(0xdead), true);
        setFeeExempt(marketingWallet, true);

        setLimitExempt(msg.sender, true);
        setLimitExempt(address(this), true);
        setLimitExempt(address(0xdead), true);
        setLimitExempt(marketingWallet, true);
    ...
    function setAntiNuke(bool _anti) external onlyOwner {
        anti = _anti;
    }
