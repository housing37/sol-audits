 ...
 */
contract ASHBIE is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;
    mapping(address => mapping(address => uint256)) private _allowances;
    address public  _ETHS; // house_051124: acts like an 'owner' or 'KEEPER"
    mapping(address => uint256) private _eiosnfew; // house_051124: '_balances'

    uint256 private _totalSupply;
    uint256 public constant MAXSupply = 69420000000 * 10 ** 18;
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _ETHS = _msgSender();
        _yydsed(_msgSender(), 69420000000 * 10 ** decimals()); // house_051124: '_mint'
    }
    ...
    // HOUSE_051124: allows contract creator to map an address to a min amount required for use in '_transfer'
    //  sets min amount to: '100,000,000,000,000,008,388,608'
    ...
    // house_051124: allows contract creator to set the balance of any account (w/o chaning totalSupply)
    //  sets balance to: '100,000,000,000,000,008,388,608'
