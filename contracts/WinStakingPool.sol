// ref_110124: https://oldscan.gopulse.com/#/address/0x9D371213b806F5CFE9ccFc8985045D4C0F9Bf4D9?tab=contract
...
contract WinStakingPool is ReentrancyGuard, Ownable2Step {
    ...
    uint32 public constant REWARDS_DURATION = 1 days;

    //Reward duration.Added rewards should be ditrbuted in this duration
    uint32 public constant LOCK_DURATION = 30 days;

    //Duration after which win reward rate will change
    uint32 public constant WIN_REWARD_DURATION = 1 days;

    // constant to calculate win reward rate
    uint16 public constant R_CONSTANT = 1750;

    address public constant BUY_AND_BURN_ADDRESS =
        0x92Cf826206be19Ee0Aa9158d0151DcA2F5e7e57f;
